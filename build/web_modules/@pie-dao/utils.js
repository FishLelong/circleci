import { c as commonjsGlobal, a as createCommonjsModule } from '../common/_commonjsHelpers-709dc846.js';
import '../common/runtime-607bd836.js';
import { p as process } from '../common/process-e9e98960.js';
import { i as isarray, r as require$$0 } from '../common/__node-resolve:empty-e7f634d3.js';
import '../common/bignumber-e85100d6.js';
import { i as isArray$1, a as isBigNumber$1, b as isPOJO$1, c as isString$2, d as isAddress$1, e as isTransactionHash$1, f as isSupportedNetworkId, g as isNumber$2, h as isNetworkId } from '../common/typeChecks-f2ab848c.js';
...
var ToPropertyDescriptor = function ToPropertyDescriptor(Obj) {
	...
	if (src(Obj, 'get')) {
		...
		if (typeof getter !== 'undefined' && !IsCallable(getter)) {
			throw new $TypeError$7('getter must be a function');
		}
		desc['[[Get]]'] = getter;
	}
	if (src(Obj, 'set')) {
...
const validateIsArray = (thing, options = {}) => {
  const defaultMessage = 'not an Array';
  return validate(isArray$1(thing), { ...options, message: options.message || defaultMessage });
};

const validateIsBigNumber = (thing, options = {}) => {
  const defaultMessage = 'not a BigNumber';
  return validate(isBigNumber$1(thing), { ...options, message: options.message || defaultMessage });
};
...
const validateIsPOJO = (thing, options = {}) => {
  const defaultMessage = 'not a POJO';
  return validate(isPOJO$1(thing), { ...options, message: options.message || defaultMessage });
};

const validateIsString = (thing, options = {}) => {
  const defaultMessage = 'not a string';
  return validate(isString$2(thing), { ...options, message: options.message || defaultMessage });
};
...
const validateIsAddress = (thing, options = {}) => {
  ...
  return validate(isAddress$1(thing), { ...options, message: options.message || defaultMessage });
};

const validateIsNetworkId = (thing, options = {}) => {
...
const validateIsSupportedNetworkId = (thing, options = {}) => {
...
const validateIsTransactionHash = (thing, options = {}) => {
  const defaultMessage = 'not an Ethereum transaction hash';
  return validate(
    isTransactionHash$1(thing),
...
const etherscanLink = ({ address, transactionHash, networkId }) => {
...
const etherscanLink$1 = etherscanLink;
const isAddress = isAddress$1;
const isBigNumber = isBigNumber$1;
const isNumber$1 = isNumber$2;
const isPOJO = isPOJO$1;
const isTransactionHash = isTransactionHash$1;
const shortenAddress$1 = shortenAddress;
const validateIsAddress$1 = validateIsAddress;
const validateIsArray$1 = validateIsArray;
const validateIsBigNumber$1 = validateIsBigNumber;
const validateIsPOJO$1 = validateIsPOJO;
const validateIsString$1 = validateIsString;

export { etherscanLink$1 as etherscanLink, isAddress, isBigNumber, isNumber$1 as isNumber, isPOJO, isTransactionHash, shortenAddress$1 as shortenAddress, validateIsAddress$1 as validateIsAddress, validateIsArray$1 as validateIsArray, validateIsBigNumber$1 as validateIsBigNumber, validateIsPOJO$1 as validateIsPOJO, validateIsString$1 as validateIsString };
